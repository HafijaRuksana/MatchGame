...
class App extends Component {
  ...
  stopTimer = () => clearInterval(this.timeId)
  ...
  thumbnailClicked = id => {
    ...
    const randomImageIndex = Math.round(Math.random() * imagesList.length)
    console.log(id)
    console.log(imagesList[0].id)
    if (id === mainImageId) {
      this.setState(prevState => ({
        score: prevState.score + 1,
        mainImageId: imagesList[randomImageIndex].id,
        randomImageNumber: randomImageIndex,
      }))
    } else {
        ...
        <div>
          <nav className="nav-container">
            <ul>
              ...
              <li className="score-details-container">
                <div>
                  <p className="score">
                ...
                <div className="timer-container">
                  ...
                  />
                  <p className="timer">{remainingTime} sec</p>
                </div>
              </li>
            </ul>
          </nav>
        ...
        {!isGameRunning ? (
          ...
          <div>
            <div className="start-image-container">
              <img
                src={imagesList[randomImageNumber].imageUrl}
                alt="match"
